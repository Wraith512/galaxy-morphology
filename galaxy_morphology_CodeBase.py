...
# %%
#path to the dataset 
IMAGE_FOLDER = r"C:\Users\ASUS\Desktop\images_training_rev1\images_training_rev1" #file contains all the jpg images 
CSV_PATH    = r"C:\Users\ASUS\Desktop\training_solutions_rev1\training_solutions_rev1.csv" #file containts the csv path to the jpgs
...
# %%
# splitting the data into train_test split (80:20)
...
# %%
#function to show random galaxy images
...
# %%
# resizing the images to 64x64 pixel size for better computation
IMG_SHAPE = (64, 64)
